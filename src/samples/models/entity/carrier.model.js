...
exports.CarrierModel = void 0;
var decorators_1 = require("../../../decorators");
var pattern_model_1 = require("../pattern.model");
var CarrierModel = /** @class */ (function (_super) {
    __extends(CarrierModel, _super);
    ...
    ], CarrierModel.prototype, "entity");
    __decorate([
        decorators_1.Column({ nullable: true })
    ], CarrierModel.prototype, "site");
    __decorate([
        decorators_1.Column({ type: 'integer', "default": 1 }) //enum: [Status], 
    ], CarrierModel.prototype, "status");
    CarrierModel = __decorate([
        decorators_1.Entity({ name: 'carriers' }),
